...
public class ButtonFloat extends Button{
	...
	public ButtonFloat(Context context, AttributeSet attrs, int sizeIcon2) {
		super(context, attrs);
		...
		LayoutParams params = new LayoutParams(Utils.dpToPx(sizeIcon2, getResources()),Utils.dpToPx(sizeIcon2, getResources()));
		params.addRule(RelativeLayout.CENTER_IN_PARENT, RelativeLayout.TRUE);
		icon.setLayoutParams(params);
		addView(icon);
	}
