...
public class ButtonRectangle extends Button {
	...
	private Typeface ROBOTO_CONDENSED_REGULAR;
	...
	protected void setAttributes(AttributeSet attrs) {
		...
		// paddingLeft = (value == null) ? paddingLeft : (int)
		// Float.parseFloat(value.replace("dip", ""));
		// value = attrs.getAttributeValue(ANDROIDXML,"paddingTop");
		// paddingTop = (value == null) ? paddingTop : (int)
		// Float.parseFloat(value.replace("dip", ""));
		// value = attrs.getAttributeValue(ANDROIDXML,"paddingRight");
		// paddingRight = (value == null) ? paddingRight : (int)
		// Float.parseFloat(value.replace("dip", ""));
		// value = attrs.getAttributeValue(ANDROIDXML,"paddingBottom");
		// paddingBottom = (value == null) ? paddingBottom : (int)
		// Float.parseFloat(value.replace("dip", ""));
		// }
		...
		if (text != null) {
			...
			textButton.setTextColor(Color.parseColor("#004C3F"));
			textButton.setTypeface(tf, Typeface.BOLD);
			
			textButton.setGravity(CENTER_HORIZONTAL);
			...
			addView(textButton);
			// FrameLayout.LayoutParams params1 = (LayoutParams)
			// textView.getLayoutParams();
			// params1.width = getWidth();
		...
		rippleSpeed = attrs.getAttributeFloatValue(MATERIALDESIGNXML,
				"rippleSpeed", Utils.dpToPx(20, getResources()));
	}
	...
	// if((textButton.getWidth()+paddingLeft+paddingRight)>Utils.dpToPx(80,
	// getResources()))
	...
	// textButton.setX(getWidth()/2-textButton.getWidth()/2 - paddingTop +
	// paddingBottom);
	// textButton.setY(getHeight()/2-textButton.getHeight()/2 - paddingLeft +
	// paddingRight);
	// txtCenter = true;
	// }
