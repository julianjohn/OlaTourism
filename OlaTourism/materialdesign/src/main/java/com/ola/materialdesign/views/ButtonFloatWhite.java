package com.ola.materialdesign.views;
...
import com.ola.materialdesign.R;
import com.ola.materialdesign.utils.Utils;
import com.nineoldandroids.animation.ObjectAnimator;
import com.nineoldandroids.view.ViewHelper;


public class ButtonFloatWhite extends Button{
	...
	public ButtonFloatWhite(Context context, AttributeSet attrs) {
		super(context, attrs);
		setBackgroundResource(R.drawable.background_button_float2);
		sizeRadius = 30;
	...
	public ButtonFloatWhite(Context context, AttributeSet attrs, int sizeIcon2) {
		super(context, attrs);
		setBackgroundResource(R.drawable.background_button_float2);
		sizeRadius = 24;
		setDefaultProperties();
		...
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(Utils.dpToPx(sizeIcon2, getResources()),Utils.dpToPx(sizeIcon2, getResources()));
		params.addRule(RelativeLayout.CENTER_IN_PARENT, RelativeLayout.TRUE);
		icon.setLayoutParams(params);
		addView(icon);
	}
	protected void setDefaultProperties(){
		rippleSpeed = Utils.dpToPx(4, getResources());
...
//		super.setDefaultProperties();
	...
	protected void setAttributes(AttributeSet attrs){
		...
		final boolean animate = attrs.getAttributeBooleanValue(MATERIALDESIGNXML,"animate", false);
			post(new Runnable() {
				...
				@Override
				public void run() {
					showPosition = ViewHelper.getY(ButtonFloatWhite.this) - Utils.dpToPx(24, getResources());
					hidePosition = ViewHelper.getY(ButtonFloatWhite.this) + getHeight() * 3;
					if(animate){
						ViewHelper.setY(ButtonFloatWhite.this, hidePosition);
						show();
					}
				}
			});
	...
	public void show(){
		ObjectAnimator animator = ObjectAnimator.ofFloat(ButtonFloatWhite.this, "y", showPosition);
	...
	public void hide(){
		...
		ObjectAnimator animator = ObjectAnimator.ofFloat(ButtonFloatWhite.this, "y", hidePosition);
		animator.setInterpolator(new BounceInterpolator());
		animator.setDuration(1500);
		animator.start();
